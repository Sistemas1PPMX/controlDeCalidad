...
<div class="container-fluid" id="preRevision">
	<div class="row flex-row m-4" id="selectores">
		...
		<div class="col-4">
			...
			<input type="text" id="revisionPlano" class="form-control" value="0" hidden="hidden">
			{{-- PIEZA INDIVIDUAL:
			<div class="row flex-row">
...
<div class="container-fluid" id="revision" style="display: none; height: 40vh;"> 
	...
	<div class="row">
		...
		<div class="col-3">
			<label>ESTAMPA DEL SOLDADOR:</label>
			<select id="estampa" class="selectpicker" multiple>
				<option value="placeholder">--Seleccionar--</option>
			</select>
		</div>
		<div class="col-2">
			<label>PROCESO:</label>
			<select id="procesoRevision" class="form-control">
				<option>FCAW</option>
				<option>GMAW</option>
				<option>SAW</option>
				<option>SMAW</option>
...
<div class="container-fluid h-100" id="tablaErrores" style="display: none;">
	<div class="row ml-4 mr-4">
		...
		<div class="col-3">
			<button class="btn btn-success btn-block h-100 rerevision" id="btnIgual" style="visibility: hidden;">FINALIZAR SIN MODIFICACION</button>
		</div>
		<div class="col-3">
