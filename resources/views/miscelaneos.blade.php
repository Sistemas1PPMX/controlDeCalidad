...
<div style="height:100%; width: 100%" id="revision" style="display: none;">
	<div class="flex-row mt-5 d-flex" id="infoRevision" style="height: 12%">
		<div class="col-3" style="height: 100%">
			...
			<div style="height: 50%">
				<input type="number" class="form-control soloNumeros" id="piezasAprobadas">
			</div>
		</div>
		<div class="col-3" style="height: 100%" style="height: 12%">
			<div style="height: 50%">
				MUESTRA:
			</div>
			<div style="height: 50%">
				<input type="number" class="form-control" id="paraAprobar" readonly="true">	
			</div>
		</div>
	...
	<div class="flex-row" id="tabla" style="width: 100%">
